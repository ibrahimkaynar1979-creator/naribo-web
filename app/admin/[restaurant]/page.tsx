...
function Editor({restaurant,p,cats,isNew,close,save,del}:{restaurant:Restaurant;p:Product;cats:Category[];isNew:boolean;close:()=>void;save:(p:Product)=>void;del:(id:string)=>void}){
 ...
 return <>
  ...
  <aside className="qaWorkbenchPreview">
   <header><div><Eye size={20}/><span><b>QR Menü Önizleme</b><small>Canlı menü görünümünüzün ürün detay ekranı.</small></span></div><span className="qaMobileBadge">Mobil</span></header>
   <div className="qaLiveMenuPhone">
    ...
    <div className="qaLiveMenuBottomNav"><span>Wi‑Fi</span><span>IBAN</span><span className="active">Garson Çağır</span><span>Geri Bildirim</span><span>Daha Fazla</span></div>
   </div>
  </aside>
 </>;
}
