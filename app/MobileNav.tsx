  ...
  return <>
    ...
    <style>{`
      ...
      @media(max-width:760px){
        ...
        .mobileNavPanel nav{display:grid;gap:5px}.mobileNavPanel nav a{display:block;padding:13px 14px;border-radius:12px;color:#e9f7fa;font-size:13px;font-weight:750;background:rgba(255,255,255,.035);text-decoration:none}
