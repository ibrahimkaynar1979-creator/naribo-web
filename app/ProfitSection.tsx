    ...
    <section className="profitSection" id="basari">
      <style>{`
        ...
        @media(max-width:760px){
          .profitSection{padding:34px 0 40px}.profitShell{width:calc(100% - 22px)}.profitHead{margin-bottom:24px}.profitKicker{font-size:11px;letter-spacing:2.4px;margin-bottom:11px;gap:9px}.profitKicker:before,.profitKicker:after{width:32px}.profitHead h2{font-size:clamp(20px,5.5vw,24px);line-height:1.06;letter-spacing:-.75px}.profitHead h2 .profitTitleLine{display:block!important;white-space:nowrap!important}.profitHead h2 .profitTitleLine+ .profitTitleLine{margin-top:4px;color:#0c9fc2}.profitHead p{margin-top:13px;font-size:15px;line-height:1.52;max-width:405px;color:#526b76}.profitStory{display:block;padding:11px;border-radius:22px}
          .orderCard{padding:21px;border-radius:17px}.orderEyebrow{font-size:10.5px;letter-spacing:1.55px}.orderTitle{margin-top:17px;font-size:25px;line-height:1.08}.orderHint{font-size:14px;line-height:1.5;margin-bottom:17px;color:#bfd0d7}.orderRows{gap:8px}.orderRow{grid-template-columns:38px 1fr auto;gap:10px;padding:12px 11px}.orderIcon{width:34px;height:34px}.orderIcon svg{width:18px;height:18px}.orderRow span{font-size:14px;line-height:1.3;color:#e4eef2}.orderRow strong{font-size:16px}.netResult{margin-top:12px;padding:15px}.netResult small{font-size:10px}.netResult b{font-size:17px}.netResult strong{font-size:32px}
          .nariboAction{margin-top:10px;padding:21px;border-radius:17px}.nariboActionKicker{font-size:10.5px;letter-spacing:1.45px}.nariboAction h3{margin-top:14px;font-size:25px;line-height:1.08}.nariboAction>p{font-size:15px;line-height:1.5;color:#526b76}.actionFlow{gap:8px;margin-top:17px}.actionItem{padding:12px 12px;font-size:14px;line-height:1.3}.actionNo{font-size:11px}.profitPromise{margin-top:16px;padding:14px 15px;font-size:14px;line-height:1.5}.profitFoot{margin-top:16px;font-size:14px;line-height:1.45;text-align:center;color:#49636e;padding:0 10px}.profitFoot svg{width:18px;height:18px;flex:0 0 auto}
        }
      `}</style>
