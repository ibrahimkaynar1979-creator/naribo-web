...
const items = [
  { icon: Settings2, title: 'MENÜ & FİYAT YÖNETİMİ', text: 'Fiyatları, ürünleri ve menü yapısını düzenli olarak optimize ediyoruz.' },
  { icon: BadgePercent, title: 'KAMPANYA YÖNETİMİ', text: 'Platform kampanyalarını takip ediyor, doğru kampanyaları kârlılığa göre yönetiyoruz.' },
  { icon: Megaphone, title: 'REKLAM YÖNETİMİ', text: 'Platform içi reklam bütçesini ve ürün görünürlüğünü satışa göre optimize ediyoruz.' },
  { icon: BarChart3, title: 'PERFORMANS TAKİBİ', text: 'Sipariş, ciro, sepet ve kazanç verilerini izleyip gerekli aksiyonları alıyoruz.' },
] as const;
  ...
  return (
    <section className="growthSystemSection" id="surekli-buyume">
      ...
      <div className="growthSystemShell">
        ...
        <div className="growthSystemLoop"><RefreshCw size={20}/><div><strong>Her ay: Analiz → Aksiyon → Ölçüm → Optimizasyon.</strong><span> Panellerinizi yalnızca takip etmiyor, satış ve kârlılık hedeflerinize göre aktif olarak yönetiyoruz.</span></div><TrendingUp size={20}/></div>
      </div>
    </section>
  );
}
