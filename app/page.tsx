    ...
    <main>
      <style>{`
        ...
        @media(min-width:761px){
          .setupSection{padding:86px 0 76px!important}
          .setupIntro{margin-bottom:48px!important}
          .setupFlow{gap:12px!important}
          .setupCard{min-height:318px!important;padding:24px 20px 25px!important;border-radius:24px!important}
          .setupTop{margin-bottom:27px!important}
          .setupIcon{width:64px!important;height:64px!important;border-radius:20px!important}
          .setupNo{font-size:31px!important}
          .setupCard h3{font-size:15px!important;min-height:38px!important;margin-bottom:12px!important}
          .setupCard p{font-size:13.5px!important;line-height:1.58!important}
          .setupConnector{top:47px!important}
          .setupFoot{margin-top:30px!important;min-height:76px!important}
        }
      ...
      <section className="approvedJourney" id="hizmetler">
        <style>{`
          .approvedJourney{background:#031722;padding:24px 0;overflow:hidden}.approvedJourneyDesktop{position:relative;width:min(1320px,calc(100% - 64px));height:430px;margin:0 auto;overflow:hidden;border-radius:30px;background:#031722}.approvedJourneyDesktop img{display:block;width:100%;height:100%;object-fit:cover;object-position:center 44%}.approvedJourneyMobile{display:none}
